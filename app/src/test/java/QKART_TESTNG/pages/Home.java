...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            ExpectedConditions.textToBePresentInElementLocated(By.xpath(String.format("//div[@class='MuiCardContent-root css-1qw96cp'][1]/p[contains(text(),'%s')]", product)), product)));
