...
public class Home {
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            WebElement noProduct=driver.findElement(By.xpath("//h4[@style='color: rgb(99, 99, 99);']"));
    ...
    public Boolean changeProductQuantityinCart(String productName, int quantity) {
        try {
            ...
            List<WebElement> cartLists = driver.findElements(By.xpath("//div[@class='MuiBox-root css-1gjj37g']"));
            for(WebElement cartList : cartLists){
                if(cartList.getText().contains(productName)){
                    String text = cartList.findElement(By.xpath("//div[@class='MuiBox-root css-olyig7']")).getText();
                    int actualQuantity = Integer.parseInt(text);
                    while(actualQuantity != quantity){
                        if(actualQuantity < quantity){
                            WebElement incrementBtn = cartList.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/button[2]"));
                            incrementBtn.click();
                            Thread.sleep(2000);
                            actualQuantity ++;
                        }else if(actualQuantity > quantity){
                            WebElement decrementBtn = cartList.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/button[1]"));
                            decrementBtn.click();
                            Thread.sleep(2000);
                            actualQuantity --;
                        }
